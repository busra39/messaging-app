...
public class KafkaListenerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MessageOriented> kafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, MessageOriented> factory =
    ...
    @Bean
    public ConsumerFactory<String, MessageOriented> consumerFactory() {
